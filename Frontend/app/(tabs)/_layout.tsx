...
import { GitBranch, GitGraph, QrCode, Settings, UserCircle, Terminal as TerminalIcon } from "lucide-react-native";
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen
        ...
        options={{
          title: "Terminal",
          tabBarIcon: ({ focused }) => <TabIcon Icon={TerminalIcon} focused={focused} />,
        }}
      />
    </Tabs>
  );
